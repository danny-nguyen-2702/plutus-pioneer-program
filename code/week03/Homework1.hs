...
mkValidator datum () ctx = (traceIfFalse "beneficiary1's signature missing" (signedByBeneficiary $ beneficiary1 datum) && 
                           traceIfFalse "deadline reached" (not deadlineReached)) ||
                           (traceIfFalse "beneficiary2's signature missing" (signedByBeneficiary $ beneficiary2 datum) && 
