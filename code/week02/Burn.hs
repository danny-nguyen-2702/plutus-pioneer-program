...
-- Now we make a validator that always fail. Which means no one can spending the money in this smart contract. That's the purpose of our Burn smart contract. It should be impossible to retrieve the funds from this Script Address, even when you use the 'grab' endpoint.
{-# INLINABLE mkValidator #-}
mkValidator :: BuiltinData -> BuiltinData -> BuiltinData -> ()
mkValidator _ _ _ = traceError "The fund has been burnt, you can't retrieve it!" 
